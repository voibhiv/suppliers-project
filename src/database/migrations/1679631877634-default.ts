...
export class default1679631877634 implements MigrationInterface {
    name = 'default1679631877634'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "company_user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "companyId" uuid, "userId" uuid, CONSTRAINT "PK_879141ebc259b4c0544b3f1ea4c" PRIMARY KEY ("id"))`);
